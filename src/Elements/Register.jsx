        ...
        <div className='flex flex-col mt-5 h-full justify-center relative self-center'>
            ...
            <form className='flex justify-center h-full' onSubmit={e => handleFormSubmit(e)}>
                <div className='vinque text-base sm:text-xl flex flex-col justify-center gap-y-6 mt-8 '>
                    <input className='placeholder: text-center text-xs sm:text-lg bg-transparent border border-solid' type="text" placeholder='set username' value={username} onChange={e => setUsername(e.target.value)} />
                    <input className='placeholder: text-center text-xs sm:text-lg bg-transparent border border-solid' type="password" placeholder='set password' value={password} onChange={e => setPassword(e.target.value)} />
